...
|---|---|---|
| `KINDLE_FONT_SIZE` | `42` | Body text size in points (large for e-reader legibility) |
...
If text feels too large, drop `KINDLE_FONT_SIZE` to `28` or `32`. If margins still feel wide, drop `KINDLE_PAGE_MARGIN` to `7` (≈ 0.1").
